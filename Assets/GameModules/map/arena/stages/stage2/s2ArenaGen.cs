...
public class s2ArenaGen : MonoBehaviour
{
    ...
    //     TileLists tiles = makeArenaTiles(new Rect(0f, 0f, width, depth));
    // }

    // #region Random Gen Alg
    // private TileLists makeArenaTiles(Rect arenaDim)
    // {
    //     TileLists tiles = new TileLists(true);
